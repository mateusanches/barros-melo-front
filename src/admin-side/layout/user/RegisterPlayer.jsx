...
const RegisterPlayer = () => {
    ...
    async function submit() {
        ...
        var authorization = dataAdmin.token;

        await axios({
            method: 'post',
            url: 'https://fut-agency-api.herokuapp.com/authentication/registerPlayer',
            data: data,
            headers: {
    ...
    return (
        <div id="cadastro-user" className="box-content">
            <h1 className="title-content">Register a new pro player</h1>
            ...
            <div className="box-form">
                ...
                <TextField value={data.lastName} onChange={e => setData({ ...data, lastName: e.target.value })} id="standard-basic" type="text" className="input-cadastro" required label="Last Name" />
                ...
                <FormControl className="input-cadastro input-country" id="standard-basic">
                ...
                <TextField value={data.stripeId} onChange={e => setData({ ...data, stripeId: e.target.value })} id="standard-basic" type="text" className="input-cadastro" required label="Verified ID" />
                <TextField value={data.twitter} onChange={e => setData({ ...data, twitter: e.target.value })} id="standard-basic" type="text" className="input-cadastro" required label="Twitter" />
                <TextField value={data.discord} onChange={e => setData({ ...data, discord: e.target.value })} id="standard-basic" type="text" className="input-cadastro" required label="Discord" />
                <TextField value={data.paypal} onChange={e => setData({ ...data, paypal: e.target.value })} id="standard-basic" type="email" className="input-cadastro" required label="Paypal email" />
